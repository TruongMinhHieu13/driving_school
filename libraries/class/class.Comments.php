        ...
        if (!empty($id)) {
            ...
            if (!empty($row['id'])) {
                ...
                if (!$this->d->update('comment', $data)) {
                    $this->errors[] = capnhattrangthaithatbai;
                }
            } else {
                $this->errors[] = dulieukhonghople;
            }
    ...
    public function delete()
    {
        ...
        if (!empty($id)) {
            ...
            if (!empty($row['id'])) {
                ...
                if (!empty($result)) {
                    $this->errors[] = xoabinhluanthatbai;
                }
            } else {
                $this->errors[] = dulieukhonghople;
            }
