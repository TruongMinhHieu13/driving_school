...
class Email
{
    ...
    private function info()
    {
        ...
        $social = array();
        $socialString = '';
        $this->company = $this->d->rawQueryOne("select options, namevi, addressvi from #_setting limit 0,1");
        ...
        $this->data['logo'] = '<img src="' . $configBase . UPLOAD_PHOTO_L . $logo['photo'] . '" style="max-height:70px;" >';
        $this->data['social'] = $socialString;
        $this->data['datesend'] = time();
        $this->data['company'] = $this->company['namevi'];
        $this->data['company:address'] = (!empty($this->optcompany['addressvi']) ? $this->optcompany['addressvi'] : '');
        ...
        $this->data['company:worktime'] = $this->optcompany['worktime'];
    }
