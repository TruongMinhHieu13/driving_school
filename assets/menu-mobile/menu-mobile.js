    ...
    if(lang == true){
        $("#menu > ul").append(
            `<li class="menu-mobile-lang">
                <a href="ngon-ngu/vi/"><img onerror="this.src='thumbs/35x25x1/assets/images/noimage.png';" alt="Tiáº¿ng Viá»‡t" src="assets/images/vi.jpg"></a>
                <a href="ngon-ngu/en/"><img onerror="this.src='thumbs/35x25x1/assets/images/noimage.png';" alt="Tiáº¿ng Anh" src="assets/images/en.jpg"></a>
            </li>`
        );
    }
