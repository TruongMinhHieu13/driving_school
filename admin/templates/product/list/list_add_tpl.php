    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
                ...
                <?php if (isset($config['product'][$type]['icon_list']) && $config['product'][$type]['icon_list'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            $photoDetail1['image'] = (!empty($item)) ? $item['icon'] : '';
                            $photoDetail1['dimension'] = "Width: " . $config['product'][$type]['width_list_icon'] . " px - Height: " . $config['product'][$type]['height_list_icon'] . " px (" . $config['product'][$type]['img_type_list'] . ")";
        ...
        <?php if (isset($flagGallery) && $flagGallery == true) { ?>
            <div class="card card-primary card-outline text-sm">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="filer-gallery" class="label-filer-gallery mb-3">Album: (<?= $config['product'][$type]['gallery_list'][$keyGallery]['img_type_photo'] ?>)</label>
