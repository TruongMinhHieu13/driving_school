    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item active"><?= quanlyhinhanhvideo ?></li>
            </ol>
        </div>
    </div>
</section>
    ...
    <form class="validation-form" novalidate method="post" id="form-watermark" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title"><?= chitiet ?> <?= $config['photo']['photo_static'][$type]['title_main'] ?></h3>
            </div>
            <div class="card-body">
                ...
                <?php } ?>
                <?php if (isset($config['photo']['photo_static'][$type]['idzalo']) && $config['photo']['photo_static'][$type]['idzalo'] == true) { ?>
                    <input type="hidden" class="idzalo" name="data[idzalo]">
                <?php } ?>
                <?php if (isset($config['photo']['photo_static'][$type]['watermark-advanced']) && $config['photo']['photo_static'][$type]['watermark-advanced'] == true) { ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-8 <?= (isset($config['photo']['photo_static'][$type]['watermark-advanced-debug']) && $config['photo']['photo_static'][$type]['watermark-advanced-debug'] == true) ? '' : 'd-none' ?>">
                ...
                <div class="row">
                    <?php if (isset($config['photo']['photo_static'][$type]['background']) && $config['photo']['photo_static'][$type]['background'] == true) { ?>
                        <div class="form-group col-md-3">
                            <label for="background_repeat"><?= tuychonlap ?>:</label>
                            <select id="background_repeat" name="data[options][background][repeat]" class="form-control select2">
                                <option value="0"><?= chonthuoctinh ?></option>
                                <option <?php if (isset($options['background']['repeat']) && $options['background']['repeat'] == 'no-repeat') echo 'selected="selected"' ?> value="no-repeat"><?= khonglaplai ?></option>
                                <option <?php if (isset($options['background']['repeat']) && $options['background']['repeat'] == 'repeat') echo 'selected="selected"' ?> value="repeat"><?= laplai ?></option>
                                <option <?php if (isset($options['background']['repeat']) && $options['background']['repeat'] == 'repeat-x') echo 'selected="selected"' ?> value="repeat-x"><?= laplaitheochieungang ?></option>
                                <option <?php if (isset($options['background']['repeat']) && $options['background']['repeat'] == 'repeat-y') echo 'selected="selected"' ?> value="repeat-y"><?= laplaitheochieudoc ?></option>
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="background_size" class="text-capitalize"><?= kichthuoc ?>:</label>
                            <select id="background_size" name="data[options][background][size]" class="form-control select2">
                                ...
                                <option <?php if (isset($options['background']['size']) && $options['background']['size'] == '100% 100%') echo 'selected="selected"' ?> value="100% 100%"><?= toanmanhinh ?></option>
                                <option <?php if (isset($options['background']['size']) && $options['background']['size'] == '100% auto') echo 'selected="selected"' ?> value="100% auto"><?= toanmanhinhtheochieungang ?></option>
                                <option <?php if (isset($options['background']['size']) && $options['background']['size'] == 'auto 100%') echo 'selected="selected"' ?> value="auto 100%"><?= toanmanhinhtheochieudoc ?></option>
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="background_position"><?= vitri ?>:</label>
                            <select id="background_position" name="data[options][background][position]" class="form-control select2">
                                <option value="0"><?= chonthuoctinh ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'left top') echo 'selected="selected"' ?> value="left top"><?= canhtraicanhtren ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'left bottom') echo 'selected="selected"' ?> value="left bottom"><?= canhtraicanhduoi ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'left center') echo 'selected="selected"' ?> value="left center"><?= canhtraicanhgiua ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'right top') echo 'selected="selected"' ?> value="right top"><?= canhphaicanhtren ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'right bottom') echo 'selected="selected"' ?> value="right bottom"><?= canhphaicanhduoi ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'right center') echo 'selected="selected"' ?> value="right center"><?= canhphaicanhgiua ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'center top') echo 'selected="selected"' ?> value="center top"><?= canhgiuacanhtren ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'center bottom') echo 'selected="selected"' ?> value="center bottom"><?= canhgiuacanhduoi ?></option>
                                <option <?php if (isset($options['background']['position']) && $options['background']['position'] == 'center center') echo 'selected="selected"' ?> value="center center"><?= canhgiuacanhgiua ?></option>
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="background_attachment"><?= codinh ?>:</label>
                            <select class="custom-select text-sm" name="data[options][background][attachment]" id="background_attachment">
                                <option <?= (isset($options['background']['attachment']) && $options['background']['attachment'] == '') ? "selected" : "" ?> value="0"><?= khongcodinh ?></option>
                                <option <?= (isset($options['background']['attachment']) && $options['background']['attachment'] == 'fixed') ? "selected" : "" ?> value="fixed"><?= codinh ?></option>
                            </select>
                        </div>
                        <div class="form-group col-md-3">
                            <label for="background_color"><?= maunen ?>:</label>
                        ...
                        <div class="form-group col-md-3">
                            <label for="type_show"><?= loaihienthi ?>:</label>
                            <select class="custom-select text-sm" name="data[options][background][type_show]" id="type_show">
                                <option value="0"><?= chontinhtrang ?></option>
                                <option <?= (isset($options['background']['type_show']) && $options['background']['type_show'] == 1) ? "selected" : "" ?> value="1"><?= hinhnen ?></option>
                                <option <?= (isset($options['background']['type_show']) && $options['background']['type_show'] == 0) ? "selected" : "" ?> value="0"><?= maunen ?></option>
                            </select>
                        </div>
                    <?php } ?>
                                    ...
                                    <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                        <?php if ((isset($config['photo']['photo_static'][$type]['name']) && $config['photo']['photo_static'][$type]['name'] == true)) { ?>
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control text-sm" name="data[name<?= $k ?>]" id="name<?= $k ?>" placeholder="<?= tieude ?> (<?= $k ?>)" value="<?= (!empty($flash->has('name' . $k))) ? $flash->get('name' . $k) : @$item['name' . $k] ?>">
                                            </div>
                                        <?php } ?>
                                        <?php if ((isset($config['photo']['photo_static'][$type]['desc']) && $config['photo']['photo_static'][$type]['desc'] == true)) { ?>
                                            <div class="form-group">
                                                <label for="desc<?= $k ?>"><?= mota ?> (<?= $k ?>):</label>
                                                <textarea class="form-control text-sm <?= ((isset($config['photo']['photo_static'][$type]['desc_cke']) && $config['photo']['photo_static'][$type]['desc_cke'] == true)) ? 'form-control-ckeditor' : '' ?>" name="data[desc<?= $k ?>]" id="desc<?= $k ?>" rows="5" placeholder="<?= mota ?> (<?= $k ?>)"><?= $func->decodeHtmlChars($flash->get('desc' . $k)) ?: $func->decodeHtmlChars(@$item['desc' . $k]) ?></textarea>
                                            </div>
                                        <?php } ?>
                                        <?php if ((isset($config['photo']['photo_static'][$type]['content']) && $config['photo']['photo_static'][$type]['content'] == true)) { ?>
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control text-sm <?= ((isset($config['photo']['photo_static'][$type]['content_cke']) && $config['photo']['photo_static'][$type]['content_cke'] == true)) ? 'form-control-ckeditor' : '' ?>" name="data[content<?= $k ?>]" id="content<?= $k ?>" rows="5" placeholder="<?= noidung ?> (<?= $k ?>)"><?= $func->decodeHtmlChars($flash->get('content' . $k)) ?: $func->decodeHtmlChars(@$item['content' . $k]) ?></textarea>
                                            </div>
                                        <?php } ?>
                                    </div>
                                <?php } ?>
