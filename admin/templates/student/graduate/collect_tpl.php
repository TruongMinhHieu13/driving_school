            ...
            <table class="table table-hover table-max-width">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle">Phí TN</th>
                    </tr>
                </thead>
                <?php if (empty($items)) { ?>
                    <tbody>
                ...
                <?php } else { ?>
                    <tbody>
                        <?php for ($i = 0; $i < count($items); $i++) {
                            ...
                            if(!empty($items[$i]['graduate'])) $feeGraduate = json_decode($items[$i]['graduate'], true)['fee-graduation'];
                            ?>
                            <tr>
                                ...
                                <td class="align-middle">
                                    <?=(!empty( $infoStudent['driving_seniority'] ) ?  $infoStudent['driving_seniority'] : '') ?>
                                </td>
                                <td class="align-middle d-flex align-items-start">
                                    <input data-id="<?= $items[$i]['id'] ?>" type="text" class="form-control text-sm format-price collect-graduation fee-graduation-<?= $items[$i]['id'] ?>" value="<?=(!empty($feeGraduate) ? $feeGraduate : 0)?>">
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
