        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <?php } ?>
                    <?php if (isset($config['setting']['hotlineP']) && $config['setting']['hotlineP'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="hotlineP">Người trực hotline:</label>
                            <input type="text" class="form-control text-sm" name="data[options][hotlineP]" id="hotlineP" placeholder="Người trực hotline" value="<?= (!empty($flash->has('hotlineP'))) ? $flash->get('hotlineP') : @$options['hotlineP'] ?>" >
                        </div>
                    <?php } ?>
                    <?php if (isset($config['setting']['phone']) && $config['setting']['phone'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="phone">Phone:</label>
                            <input type="text" class="form-control text-sm" name="data[options][phone]" id="phone" placeholder="Phone" value="<?= (!empty($flash->has('phone'))) ? $flash->get('phone') : @$options['phone'] ?>" required>
                        </div>
                    <?php } ?>
                    ...
                    <?php } ?>
                    <?php if (isset($config['setting']['link_tiktok']) && $config['setting']['link_tiktok'] == true) { ?>
                        <div class="form-group col-md-4 col-sm-6">
                            <label for="link_tiktok">Link Tiktok:</label>
                            <input type="text" class="form-control text-sm" name="data[options][link_tiktok]" id="link_tiktok" placeholder="link Tiktok" value="<?= (!empty($flash->has('link_tiktok'))) ? $flash->get('link_tiktok') : @$options['link_tiktok'] ?>">
                        </div>
                    <?php } ?>
                ...
                <?php if (isset($config['setting']['tiktok']) && $config['setting']['tiktok'] == true) { ?>
                    <div class="form-group">
                        <label for="tiktok">
                            <span>Tiktok:</span>
                            <a class="text-sm font-weight-normal ml-1" href="https://developers.tiktok.com/doc/embed-creator-profiles/" target="_blank" title="Hướng dẫn lấy mã nhúng tiktok">(Hướng dẫn lấy mã nhúng Tiktok)</a>
                        </label>
                        <textarea class="form-control text-sm" name="data[options][tiktok]" id="tiktok" rows="5" placeholder="Tiktok"><?= $func->decodeHtmlChars($flash->get('tiktok')) ?: $func->decodeHtmlChars(@$options['tiktok']) ?></textarea>
                    </div>
                <?php } ?>
                <div class="form-group">
