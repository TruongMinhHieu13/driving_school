    ...
    <form class="validation-form" novalidate method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                        <?php foreach ($config['website']['lang'] as $k => $v) { ?>
                                            <div class="tab-pane fade show <?= ($k == 'vi') ? 'active' : '' ?>" id="tabs-lang-<?= $k ?>" role="tabpanel" aria-labelledby="tabs-lang">
                                                ...
                                                <?php if (isset($config['static'][$type]['desc2']) && $config['static'][$type]['desc2'] == true) { ?>
                                                    <div class="form-group">
                                                        <label for="desc2<?= $k ?>">Slogan (<?= $k ?>):</label>
                                                        <input type="text" class="form-control for-seo text-sm" name="data[desc2<?= $k ?>]" id="desc2<?= $k ?>" placeholder="Slogan (<?= $k ?>)" value="<?= (!empty($flash->has('desc2' . $k))) ? $flash->get('desc2' . $k) : @$item['desc2' . $k] ?>" required>
                                                    </div>
                                                <?php } ?>
                                                
                                                <?php if (isset($config['static'][$type]['link_video']) && $config['static'][$type]['link_video'] == true) { ?>
                                                    <div class="form-group">
                                                        <label for="link_video">Link Video:</label>
                                                        <input type="text" class="form-control for-seo text-sm" name="data[link_video]" id="link_video" rows="1" placeholder="Link Video" value="<?= $func->decodeHtmlChars($flash->get('link_video')) ?: $func->decodeHtmlChars(@$item['link_video']) ?>">
                                                    </div>
                                                <?php } ?>
                ...
                <?php if (isset($config['static'][$type]['images2']) && $config['static'][$type]['images2'] == true) { ?>
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            ...
                            /* Photo detail */
                            $photoDetail2 = array();
                            $photoDetail2['upload'] = UPLOAD_NEWS_L;
                            $photoAction = 'photo2';
                            $photoDetail2['image'] = (!empty($item)) ? $item['photo2'] : '';
                            $photoDetail2['dimension'] = "Width: " . $config['static'][$type]['width2'] . " px - Height: " . $config['static'][$type]['height2'] . " px (" . $config['static'][$type]['img_type'] . ")";
        ...
        <?php if (isset($flagGallery) && $flagGallery == true) { ?>
            <div class="card card-primary card-outline text-sm">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="filer-gallery" class="label-filer-gallery mb-3">Hình ảnh <?= $config['static'][$type]['title_main'] ?> ( 410x550 ): (<?= $config['static'][$type]['gallery'][$keyGallery]['img_type_photo'] ?>) <br> Tối đa 4 hình ảnh</label>
