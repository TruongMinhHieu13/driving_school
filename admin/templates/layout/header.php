...
<nav class="main-header navbar navbar-expand navbar-white navbar-light text-sm">
    ...
    <ul class="navbar-nav ml-auto align-items-center">
        ...
        <?php if ((!empty($config['contact']['active'] && $config['contact']['active'] == true)) ||
                isset($config['order']['active']) && $config['order']['active'] == true ||
                !empty($commentProductNotify) ||
                    !empty($commentNewsNotify) ||
                        !empty($newsletterNotify)
    ){ ?>
            <li class="nav-item dropdown">
        ...
        <?php } ?>
        <li class="nav-item d-sm-inline-block">
            <a href="index.php?com=user&act=logout" class="nav-link"><i class="fas fa-sign-out-alt mr-1"></i><?=dangxuat?></a>
        </li>
    </ul>
</nav>