    ...
    <div class="sidebar">
        <nav class="mt-3">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent text-sm" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <?php if (isset($v['color']) && $v['color'] == true) {
                                        ...
                                        if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('product', 'man_color', $k, null, 'phrase-1')) $none = "d-none";
                                        if ($com == 'product' && ($act == 'man_color' || $act == 'add_color' || $act == 'edit_color') && $k == $_GET['type']) $active = "active"; ?>
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_color&type=<?= $k ?>" title="Màu sắc"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Màu sắc</p>
                                            </a></li>
                                    <?php } ?>
                                    <?php if (isset($v['size']) && $v['size'] == true) {
                                        ...
                                        if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('product', 'man_size', $k, null, 'phrase-1')) $none = "d-none";
                                        if ($com == 'product' && ($act == 'man_size' || $act == 'add_size' || $act == 'edit_size') && $k == $_GET['type']) $active = "active"; ?>
                                        <li class="nav-item <?= $none ?>"><a class="nav-link <?= $active ?>" href="index.php?com=product&act=man_size&type=<?= $k ?>" title="Size"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                                <p>Size</p>
                                            </a></li>
                                    <?php } ?>
                                    <?php
                ...
                $active = "";
                $menuopen = "";
                if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('courses', 'man', '', '', 'phrase-1')) $none = "d-none";
                if ($com == 'courses') {
                    $active = 'active';
                    $menuopen = 'menu-open';
                }
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="#" title="Danh sách khoá học">
                        <i class="nav-icon text-sm far fa-newspaper"></i>
                        <p>
                            Danh sách khoá học
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('courses', 'man', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'courses' && $act == 'add') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=courses&act=add" title="Thêm khoá học"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Thêm khoá học</p>
                            </a>
                        </li>
                        ...
                        <?php
                            ...
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('courses', 'man', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'courses' && $act == 'man') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=courses&act=man" title="Kho khoá học"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Kho khoá học</p>
                            </a>
                        </li>
                    </ul>
                ...
                $active = "";
                $menuopen = "";
                if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('teacher', 'man', '', '', 'phrase-1') && $func->checkPermission('teacher', 'add', '', '', 'phrase-1')) $none = "d-none";
                if ($com == 'teacher') {
                    $active = 'active';
                    $menuopen = 'menu-open';
                }
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="#" title="Danh sách giáo viên">
                        <i class="nav-icon text-sm far fa-newspaper"></i>
                        <p>
                            Danh sách giáo viên
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('teacher', 'add', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'teacher' && $act == 'add') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=teacher&act=add" title="Thêm giáo viên"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Thêm giáo viên</p>
                            </a>
                        </li>
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('teacher', 'man', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'teacher' && $act == 'man') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=teacher&act=man" title="Kho giáo viên"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Kho giáo viên</p>
                            </a>
                        </li>
                    </ul>
                ...
                $active = "";
                $menuopen = "";
                if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('car', 'man', '', '', 'phrase-1')) $none = "d-none";
                if ($com == 'car') {
                    $active = 'active';
                    $menuopen = 'menu-open';
                }
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="#" title="Danh sách xe">
                        <i class="nav-icon text-sm far fa-newspaper"></i>
                        <p>
                            Danh sách xe
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('car', 'add', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'car' && $act == 'add') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=car&act=add" title="Thêm xe"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Thêm xe</p>
                            </a>
                        </li>
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('car', 'man', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'car' && $act == 'man') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=car&act=man" title="Kho xe"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Kho xe</p>
                            </a>
                        </li>
                    </ul>
                ...
                $active = "";
                $menuopen = "";
                if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('student', 'man', '', '', 'phrase-1') && $func->checkPermission('student', 'add', '', '', 'phrase-1') && $func->checkPermission('student', 'delete', '', '', 'phrase-1') && $func->checkPermission('student', 'gplx', '', '', 'phrase-1') && $func->checkPermission('student', 'getBC1', '', '', 'phrase-1')) $none = "d-none";
                if ($com == 'student' && ($act == 'add' || $act == 'edit' || $act == 'gplx' || $act == 'man' || $act == 'getBC1')) {
                    $active = 'active';
                    $menuopen = 'menu-open';
                }
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="#" title="Danh sách học viên">
                        <i class="nav-icon text-sm far fa-newspaper"></i>
                        <p>
                            Danh sách học viên
                            <i class="right fas fa-angle-left"></i>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('student', 'add', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && $act == 'add') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=add" title="Thêm học viên"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Thêm học viên</p>
                            </a>
                        </li>
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('student', 'gplx', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && ($act == 'gplx' || $act == 'add-gplx' || $act == 'edit-gplx')) $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?> <?=var_dump($func->checkPermission('student', 'gplx', null, 'phrase-1'));?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=gplx" title="Thêm hạng xe (hạng GPLX)"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Thêm hạng xe (hạng GPLX)</p>
                            </a>
                        </li>
                        ...
                        <!-- Quản lý học viên -->
                            ...
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('student', 'man', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && $act == 'man') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=man&fill=man" title="Kho học viên"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Kho học viên</p>
                            </a>
                        </li>
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('student', 'getBC1', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && $act == 'getBC1') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=getBC1" title="Kho học viên"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Thư ký lấy File BC1</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                $active = "";
                $menuopen = "";
                if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('teacher', 'theory', '', '', 'phrase-1') && $func->checkPermission('teacher', 'geometry', '', '', 'phrase-1') && $func->checkPermission('teacher', 'cabin', '', '', 'phrase-1') && $func->checkPermission('teacher', 'dat', '', '', 'phrase-1') && $func->checkPermission('student', 'collect-graduation', '', '', 'phrase-1')) $none = "d-none";
                if ($com == 'student' && ($act == 'manGraduate' || $act == 'collect-graduation')) {
                    $active = 'active';
                    $menuopen = 'menu-open';
                }
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('teacher', 'theory', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && $act == 'manGraduate' && $type == 'theory') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=manGraduate&type=theory&status=all" title="Duyệt lý thuyết"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Duyệt lý thuyết</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('teacher', 'geometry', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && $act == 'manGraduate' && $type == 'geometry') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=manGraduate&type=geometry&status=all" title="Duyệt hình"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Duyệt hình</p>
                            </a>
                        </li>
                    </ul>
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('teacher', 'cabin', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && $act == 'manGraduate' && $type == 'cabin') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=manGraduate&type=cabin&status=all" title="Duyệt Cabin"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Duyệt Cabin</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('teacher', 'dat', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && $act == 'manGraduate' && $type == 'dat') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=manGraduate&type=dat&status=all" title="Duyệt DAT"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Duyệt DAT</p>
                            </a>
                        </li>
                    </ul>
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <?php
                            $none = "";
                            $active = "";
                            if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('student', 'collect-graduation', '', null, 'phrase-1')) $none = "d-none";
                            if ($com == 'student' && $act == 'collect-graduation') $active = "active";
                            ?>
                            <li class="nav-item <?= $none ?>">
                            <a class="nav-link <?= $active ?>" href="index.php?com=student&act=collect-graduation" title="Thu phí tốt nghiệp"><i class="nav-icon text-sm far fa-caret-square-right"></i>
                                <p>Thu phí tốt nghiệp</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                $active = "";
                $menuopen = "";
                if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('graduate', 'man', '', '', 'phrase-1')) $none = "d-none";
                if ($com == 'graduate' && $act =='man') {
                    $active = 'active';
                    $menuopen = 'menu-open';
                }
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="index.php?com=graduate&act=man" title="Tốt nghiệp">
                        <i class="nav-icon text-sm far fa-newspaper"></i>
                        <p>
                            Tốt nghiệp
                        </p>
                ...
                $active = "";
                $menuopen = "";
                if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('graduate', 'manImport', '', '', 'phrase-1')) $none = "d-none";
                if ($com == 'graduate' && $act=='manImport') {
                    $active = 'active';
                    $menuopen = 'menu-open';
                }
                ?>
                <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                    <a class="nav-link <?= $active ?>" href="index.php?com=graduate&act=manImport" title="Import File Xác Hạch">
                        <i class="nav-icon text-sm far fa-newspaper"></i>
                        <p>
                            Import File Xác Hạch
                        </p>
                    </a>
                </li>
                ...
                <?php
                    ...
                    $active = "";
                    $menuopen = "";
                    if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('history', 'man', '', '', 'phrase-1')) $none = "d-none";
                    if ($com == 'history') {
                        $active = 'active';
                        $menuopen = 'menu-open';
                    }
                    ?>
                    <li class="nav-item has-treeview <?= $menuopen ?> <?= $none ?>">
                        <a class="nav-link <?= $active ?>" href="#" title="Lịch sử">
                            <i class="nav-icon text-sm fas fa-share-alt"></i>
                            <p>
                                Lịch sử
                                <i class="right fas fa-angle-left"></i>
                        ...
                        <ul class="nav nav-treeview">
                           <?php
                               $none = "";
                               $active = "";
                               if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('history', 'man', '', null, 'phrase-1')) $none = "d-none";
                               if ($com == 'history') {
                                   if ($act == 'man') $active = 'active';
                               }
                               ?>
                               <li class="nav-item <?= $active ?> <?= $none ?>">
                                <a class="nav-link <?= $active ?>" href="index.php?com=history&act=man&fill=man" title="Import - Export">
                            ...
                            <?php
                               $none = "";
                               $active = "";
                               if (isset($is_permission) && $is_permission == true) if ($func->checkPermission('history', 'fee', '', null, 'phrase-1')) $none = "d-none";

                               if ($com == 'history') {
                                   if ($act == 'fee') $active = 'active';
                               }
                               ?>
                               <li class="nav-item <?= $active ?> <?= $none ?>">
                                <a class="nav-link <?= $active ?>" href="index.php?com=history&act=fee" title="Thu phí">
                                    <i class="nav-icon text-sm fas fa-cogs"></i>
                                    <p>Thu phí</p>
                                </a>
                            </li>
